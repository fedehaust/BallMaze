...
Ball.Preloader.prototype = {
	preload: function() {
        this.levelText = this.game.add.text((Ball._WIDTH-65)*0.5, (Ball._HEIGHT)*0.5, "Cargando", { font: "16px Arial", fill: "#e4beef" });
        ...
        this.load.image('element-c', 'img/element-c.png');
		this.load.image('panel', 'img/panel.png');
		this.load.image('title', 'img/title.png');
		this.load.image('button-pause', 'img/button-pause.png');
        this.load.image('button-next', 'img/button-next.png');
